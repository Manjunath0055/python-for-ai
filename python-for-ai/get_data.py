...
""" 
The below code is realted about 
api with importing requests 
which help to get data from web services
...
"""
The below code is realted about
date formatting with imporing pandas which help to
...
"""
The below code is realted about
data visualization with imporing matplotlib
which help to plot data in graphical form
